from tensorflow.keras.layers import Conv2D, Conv2DTranspose, BatchNormalization, Add
from tensorflow.keras.layers import MaxPooling2D, Activation, Dropout, concatenate, Input
...
class CustomNested:
    ...
    def create_model(self):
        ...
        model = Model([inputs1, inputs2], outputs, name="CustomNested")
