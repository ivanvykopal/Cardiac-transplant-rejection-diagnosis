...
def run(wandb_key=None, data_path=None, output_path=None, show_plots=True):
    config_name = 'config_deeplab_ikem_class'
    project_name = 'DP DeepLabV3Plus IKEM CLASS 2'

    json_path = './data/images_512-splitted2.json'
    if data_path is None:
        data_directory = 'D:\\Master Thesis\\Code\\Segmentation\\data3'
    else:
    ...
    model = DeepLabV3Plus(config).create_model()
...
if __name__ == '__main__':
    ...
    run(wandb_key=args.wandb, data_path=args.data_path,
        output_path=args.output_path, show_plot=False)
